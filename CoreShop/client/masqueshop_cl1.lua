...
elseif btn == "~r~Quitter le menu" then
	...
	CloseMenu('ClosesShops')
				---------cochon
			elseif slide == 2 and btn == "Masque:" then
				OpenMenu('Cochon')
			elseif slide == 1 and btn == "Masque Cochon" then
				TriggerServerEvent('marseille:achat', 100, "Masque1", "Masque1")
			elseif slide == 2 and btn == "Masque Cochon" then
				TriggerServerEvent('marseille:achat', 100, "Masque1_2", "Masque1_2")
			elseif slide == 3 and btn == "Masque Cochon" then
				TriggerServerEvent('marseille:achat', 100, "Masque1_3", "Masque1_3")
				---------Sekelet
			elseif slide == 3 and btn == "Masque:" then
				OpenMenu('Skelet')
			elseif slide == 1 and btn == "Masque Skelet" then
				TriggerServerEvent('marseille:achat', 100, "Masque2", "Masque2")
			elseif slide == 2 and btn == "Masque Skelet" then
				TriggerServerEvent('marseille:achat', 100, "Masque2_1", "Masque2_1")
			elseif slide == 3 and btn == "Masque Skelet" then
				TriggerServerEvent('marseille:achat', 100, "Masque2_2", "Masque2_2")
					---------Singe
			elseif slide == 4 and btn == "Masque:" then  
			TriggerServerEvent('marseille:achat', 100, "Masque3", "Masque3")
				---------Hockey 1
			elseif slide == 5 and btn == "Masque:" then
				OpenMenu('Hockey 1')
			elseif slide == 1 and btn == "Masque Hockey 1" then
				TriggerServerEvent('marseille:achat', 100, "Masque4", "Masque4")
			elseif slide == 2 and btn == "Masque Hockey 1" then
				TriggerServerEvent('marseille:achat', 100, "Masque4_1", "Masque4_1")
			elseif slide == 3 and btn == "Masque Hockey 1" then
				TriggerServerEvent('marseille:achat', 100, "Masque4_2", "Masque4_2")
					---------Singe 2
			elseif slide == 6 and btn == "Masque:" then
				OpenMenu('Singe 2')
			elseif slide == 1 and btn == "Masque Singe 2" then
				TriggerServerEvent('marseille:achat', 100, "Masque5", "Masque5")
			elseif slide == 2 and btn == "Masque Singe 2" then
				TriggerServerEvent('marseille:achat', 100, "Masque5_1", "Masque5_1")
			elseif slide == 3 and btn == "Masque Singe 2" then
				TriggerServerEvent('marseille:achat', 100, "Masque5_2", "Masque5_2")
				---------Clown
			elseif slide == 7 and btn == "Masque:" then
				OpenMenu('Clown')
			elseif slide == 1 and btn == "Masque Clown" then
				TriggerServerEvent('marseille:achat', 100, "Masque6", "Masque6")
			elseif slide == 2 and btn == "Masque Clown" then
				TriggerServerEvent('marseille:achat', 100, "Masque6_1", "Masque6_1")
			elseif slide == 3 and btn == "Masque Clown" then
				TriggerServerEvent('marseille:achat', 100, "Masque6_2", "Masque6_2")
					---------Devil
			elseif slide == 8 and btn == "Masque:" then
				OpenMenu('Devil')
			elseif slide == 1 and btn == "Masque Devil" then
				TriggerServerEvent('marseille:achat', 100, "Masque7", "Masque7")
			elseif slide == 2 and btn == "Masque Devil" then
				TriggerServerEvent('marseille:achat', 100, "Masque7_1", "Masque7_1")
			elseif slide == 3 and btn == "Masque Devil" then
				TriggerServerEvent('marseille:achat', 100, "Masque7_2", "Masque7_2")
				---------Pernowell
			elseif slide == 9 and btn == "Masque:" then
				OpenMenu('Pernowell')
			elseif slide == 1 and btn == "Masque Pernowell" then
				TriggerServerEvent('marseille:achat', 100, "Masque8", "Masque8")
			elseif slide == 2 and btn == "Masque Pernowell" then
				TriggerServerEvent('marseille:achat', 100, "Masque8_1", "Masque8_1")
			elseif slide == 3 and btn == "Masque Pernowell" then
				TriggerServerEvent('marseille:achat', 100, "Masque8_2", "Masque8_2")
				---------Serre
			elseif slide == 10 and btn == "Masque:" then  	
			TriggerServerEvent('marseille:achat', 100, "Masque9", "Masque9")
					---------Serre
			elseif slide == 11 and btn == "Masque:" then  	
			TriggerServerEvent('marseille:achat', 100, "Masque10", "Masque10")
				---------Lunettes
			elseif slide == 12 and btn == "Masque:" then
				OpenMenu('Lunettes')
			elseif slide == 1 and btn == "Masque Lunettes" then
				TriggerServerEvent('marseille:achat', 100, "Masque11", "Masque11")
			elseif slide == 2 and btn == "Masque Lunettes" then
				TriggerServerEvent('marseille:achat', 100, "Masque11_1", "Masque11_1")
			elseif slide == 3 and btn == "Masque Lunettes" then
				TriggerServerEvent('marseille:achat', 100, "Masque11_2", "Masque11_2")
						---------Lunettes2
			elseif slide == 13 and btn == "Masque:" then
				OpenMenu('Lunettes 2')
			elseif slide == 1 and btn == "Masque Lunettes 2" then
				TriggerServerEvent('marseille:achat', 100, "Masque12", "Masque12")
			elseif slide == 2 and btn == "Masque Lunettes 2" then
				TriggerServerEvent('marseille:achat', 100, "Masque12_1", "Masque12_1")
			elseif slide == 3 and btn == "Masque Lunettes 2" then
				TriggerServerEvent('marseille:achat', 100, "Masque12_2", "Masque12_2")
				---------Serre
			elseif slide == 14 and btn == "Masque:" then  	
			TriggerServerEvent('marseille:achat', 100, "Masque13", "Masque13")
						---------Hockey2
			elseif slide == 15 and btn == "Masque:" then
				OpenMenu('Hockey 2')
			elseif slide == 1 and btn == "Masque Hockey 2" then
				TriggerServerEvent('marseille:achat', 100, "Masque14", "Masque14")
			elseif slide == 2 and btn == "Masque Hockey 2" then
				TriggerServerEvent('marseille:achat', 100, "Masque14_1", "Masque14_1")
			elseif slide == 3 and btn == "Masque Hockey 2" then
				TriggerServerEvent('marseille:achat', 100, "Masque14_2", "Masque14_2")
						---------Hockey3
			elseif slide == 16 and btn == "Masque:" then
				OpenMenu('Hockey 3')
			elseif slide == 1 and btn == "Masque Hockey 3" then
				TriggerServerEvent('marseille:achat', 100, "Masque15", "Masque15")
			elseif slide == 2 and btn == "Masque Hockey 3" then
				TriggerServerEvent('marseille:achat', 100, "Masque15_1", "Masque15_1")
			elseif slide == 3 and btn == "Masque Hockey 3" then
				TriggerServerEvent('marseille:achat', 100, "Masque15_2", "Masque15_2")
					---------Terminator
			elseif slide == 17 and btn == "Masque:" then
				OpenMenu('Terminator')
			elseif slide == 1 and btn == "Masque Terminator" then
				TriggerServerEvent('marseille:achat', 100, "Masque16", "Masque16")
			elseif slide == 2 and btn == "Masque Terminator" then
				TriggerServerEvent('marseille:achat', 100, "Masque16_1", "Masque16_1")
			elseif slide == 3 and btn == "Masque Terminator" then
				TriggerServerEvent('marseille:achat', 100, "Masque16_2", "Masque16_2")
				---------Chat
			elseif slide == 18 and btn == "Masque:" then
				OpenMenu('Chat')
			elseif slide == 1 and btn == "Masque Chat" then
				TriggerServerEvent('marseille:achat', 100, "Masque17", "Masque17")
			elseif slide == 2 and btn == "Masque Chat" then
				TriggerServerEvent('marseille:achat', 100, "Masque17_1", "Masque17_1")
			elseif slide == 3 and btn == "Masque Chat" then
				TriggerServerEvent('marseille:achat', 100, "Masque17_2", "Masque17_2")
				---------Renard
			elseif slide == 19 and btn == "Masque:" then
				OpenMenu('Renard')
			elseif slide == 1 and btn == "Masque Renard" then
				TriggerServerEvent('marseille:achat', 100, "Masque18", "Masque18")
			elseif slide == 2 and btn == "Masque Renard" then
				TriggerServerEvent('marseille:achat', 100, "Masque18_1", "Masque18_1")
			elseif slide == 3 and btn == "Masque Renard" then
				TriggerServerEvent('marseille:achat', 100, "Masque18_2", "Masque18_2")
				---------Hibout
			elseif slide == 20 and btn == "Masque:" then
				OpenMenu('Hibout')
			elseif slide == 1 and btn == "Masque Hibout" then
				TriggerServerEvent('marseille:achat', 100, "Masque19", "Masque19")
			elseif slide == 2 and btn == "Masque Hibout" then
				TriggerServerEvent('marseille:achat', 100, "Masque19_1", "Masque19_1")
			elseif slide == 3 and btn == "Masque Hibout" then
				TriggerServerEvent('marseille:achat', 100, "Masque19_2", "Masque19_2")
					---------Raton
			elseif slide == 21 and btn == "Masque:" then
				OpenMenu('Raton')
			elseif slide == 1 and btn == "Masque Raton" then
				TriggerServerEvent('marseille:achat', 100, "Masque20", "Masque20")
			elseif slide == 2 and btn == "Masque Raton" then
				TriggerServerEvent('marseille:achat', 100, "Masque20_1", "Masque20_1")
			elseif slide == 3 and btn == "Masque Raton" then
				TriggerServerEvent('marseille:achat', 100, "Masque20_2", "Masque20_2")
					---------Ours Boeuf
			elseif slide == 22 and btn == "Masque:" then
				OpenMenu('Ours')
			elseif slide == 1 and btn == "Masque Ours" then
				TriggerServerEvent('marseille:achat', 100, "Masque21", "Masque21")
			elseif slide == 2 and btn == "Masque Ours" then
				TriggerServerEvent('marseille:achat', 100, "Masque21_1", "Masque21_1")
			elseif slide == 3 and btn == "Masque Ours" then
				TriggerServerEvent('marseille:achat', 100, "Masque21_2", "Masque21_2")
						---------Boeuf
			elseif slide == 23 and btn == "Masque:" then
				OpenMenu('Boeuf')
			elseif slide == 1 and btn == "Masque Boeuf" then
				TriggerServerEvent('marseille:achat', 100, "Masque22", "Masque22")
			elseif slide == 2 and btn == "Masque Boeuf" then
				TriggerServerEvent('marseille:achat', 100, "Masque22_1", "Masque22_1")
			elseif slide == 3 and btn == "Masque Boeuf" then
				TriggerServerEvent('marseille:achat', 100, "Masque22_2", "Masque22_2")
					---------Boeuf 2
			elseif slide == 24 and btn == "Masque:" then
				OpenMenu('Boeuf 2')
			elseif slide == 1 and btn == "Masque Boeuf 2" then
				TriggerServerEvent('marseille:achat', 100, "Masque23", "Masque23")
			elseif slide == 2 and btn == "Masque Boeuf 2" then
				TriggerServerEvent('marseille:achat', 100, "Masque23_1", "Masque23_1")
			elseif slide == 3 and btn == "Masque Boeuf 2" then
				TriggerServerEvent('marseille:achat', 100, "Masque23_2", "Masque23_2")
					---------Tête
			elseif slide == 25 and btn == "Masque:" then
				OpenMenu('Tête')
			elseif slide == 1 and btn == "Masque Tête" then
				TriggerServerEvent('marseille:achat', 100, "Masque24", "Masque24")
			elseif slide == 2 and btn == "Masque Tête" then
				TriggerServerEvent('marseille:achat', 100, "Masque24_1", "Masque24_1")
			elseif slide == 3 and btn == "Masque Tête" then
				TriggerServerEvent('marseille:achat', 100, "Masque24_2", "Masque24_2")
						---------Tête 2
			elseif slide == 26 and btn == "Masque:" then
				OpenMenu('Tête 2')
			elseif slide == 1 and btn == "Masque Tête 2" then
				TriggerServerEvent('marseille:achat', 100, "Masque25", "Masque25")
			elseif slide == 2 and btn == "Masque Tête 2" then
				TriggerServerEvent('marseille:achat', 100, "Masque25_1", "Masque25_1")
			elseif slide == 3 and btn == "Masque Tête 2" then
				TriggerServerEvent('marseille:achat', 100, "Masque25_2", "Masque25_2")
				---------Loup
			elseif slide == 27 and btn == "Masque:" then
				OpenMenu('Loup')
			elseif slide == 1 and btn == "Masque Loup" then
				TriggerServerEvent('marseille:achat', 100, "Masque26", "Masque26")
			elseif slide == 2 and btn == "Masque Loup" then
				TriggerServerEvent('marseille:achat', 100, "Masque26_1", "Masque26_1")
			elseif slide == 3 and btn == "Masque Loup" then
				TriggerServerEvent('marseille:achat', 100, "Masque26_2", "Masque26_2")
				---------Casque d'avion
			elseif slide == 28 and btn == "Masque:" then  	
			TriggerServerEvent('marseille:achat', 100, "Masque27", "Masque27")
					---------Monster 1
			elseif slide == 29 and btn == "Masque:" then
				OpenMenu('Monster')
			elseif slide == 1 and btn == "Masque Monster" then
				TriggerServerEvent('marseille:achat', 100, "Masque28", "Masque28")
			elseif slide == 2 and btn == "Masque Monster" then
				TriggerServerEvent('marseille:achat', 100, "Masque28_1", "Masque28_1")
			elseif slide == 3 and btn == "Masque Monster" then
				TriggerServerEvent('marseille:achat', 100, "Masque28_2", "Masque28_2")
				---------Monster 2
			elseif slide == 30 and btn == "Masque:" then
				OpenMenu('Monster 2')
			elseif slide == 1 and btn == "Masque Monster 2" then
				TriggerServerEvent('marseille:achat', 100, "Masque29", "Masque29")
			elseif slide == 2 and btn == "Masque Monster 2" then
				TriggerServerEvent('marseille:achat', 100, "Masque29_1", "Masque29_1")
			elseif slide == 3 and btn == "Masque Monster 2" then
				TriggerServerEvent('marseille:achat', 100, "Masque29_2", "Masque29_2")
				---------Hockey 4
			elseif slide == 31 and btn == "Masque:" then  	TriggerServerEvent('marseille:achat', 100, "Masque30", "Masque30")
				---------Hockey 4
			elseif slide == 32 and btn == "Masque:" then  	TriggerServerEvent('marseille:achat', 100, "Masque31", "Masque31")
					---------Cagoule
			elseif slide == 33 and btn == "Masque:" then  	TriggerServerEvent('marseille:achat', 100, "Masque32", "Masque32")
				---------Coukies
			elseif slide == 34 and btn == "Masque:" then  	TriggerServerEvent('marseille:achat', 100, "Masque33", "Masque33")
				---------old
			elseif slide == 35 and btn == "Masque:" then
				OpenMenu('Old')
			elseif slide == 1 and btn == "Masque Old" then
				TriggerServerEvent('marseille:achat', 100, "Masque34", "Masque34")
			elseif slide == 2 and btn == "Masque Old" then
				TriggerServerEvent('marseille:achat', 100, "Masque34_1", "Masque34_1")
			elseif slide == 3 and btn == "Masque Old" then
				TriggerServerEvent('marseille:achat', 100, "Masque34_2", "Masque34_2")
					---------Cagoule 1
			elseif slide == 36 and btn == "Masque:" then  TriggerServerEvent('marseille:achat', 100, "Masque35", "Masque35")
				---------Mask oxygen
			elseif slide == 37 and btn == "Masque:" then  TriggerServerEvent('marseille:achat', 100, "Masque36", "Masque36")
					---------Cagoule 3
			elseif slide == 38 and btn == "Masque:" then  TriggerServerEvent('marseille:achat', 100, "Masque37", "Masque37")
				---------Mask oxygen 2
			elseif slide == 39 and btn == "Masque:" then  TriggerServerEvent('marseille:achat', 100, "Masque38", "Masque38")
					---------Monster 3
			elseif slide == 40 and btn == "Masque:" then
				OpenMenu('Monster 3')
			elseif slide == 1 and btn == "Masque Monster 3" then
				TriggerServerEvent('marseille:achat', 100, "Masque39", "Masque39")
			elseif slide == 2 and btn == "Masque Monster 3" then
				TriggerServerEvent('marseille:achat', 100, "Masque39_1", "Masque39_1")
			elseif slide == 3 and btn == "Masque Monster 3" then
				TriggerServerEvent('marseille:achat', 100, "Masque39_2", "Masque39_2")
					---------Monster 4
			elseif slide == 41 and btn == "Masque:" then
				OpenMenu('Monster 4')
			elseif slide == 1 and btn == "Masque Monster 4" then
				TriggerServerEvent('marseille:achat', 100, "Masque40", "Masque40")
			elseif slide == 2 and btn == "Masque Monster 4" then
				TriggerServerEvent('marseille:achat', 100, "Masque40_1", "Masque40_1")
			elseif slide == 3 and btn == "Masque Monster 4" then
				TriggerServerEvent('marseille:achat', 100, "Masque40_2", "Masque40_2")
					---------Monster 5
			elseif slide == 42 and btn == "Masque:" then
				OpenMenu('Monster 4')
			elseif slide == 1 and btn == "Masque Monster 5" then
				TriggerServerEvent('marseille:achat', 100, "Masque41", "Masque41")
			elseif slide == 2 and btn == "Masque Monster 5" then
				TriggerServerEvent('marseille:achat', 100, "Masque41_1", "Masque41_1")
			elseif slide == 3 and btn == "Masque Monster 5" then
				TriggerServerEvent('marseille:achat', 100, "Masque41_1", "Masque41_1")
										---------Monster 6
			elseif slide == 43 and btn == "Masque:" then
				OpenMenu('Monster 4')
			elseif slide == 1 and btn == "Masque Monster 6" then
				TriggerServerEvent('marseille:achat', 100, "Masque42", "Masque42")
			elseif slide == 2 and btn == "Masque Monster 6" then
				TriggerServerEvent('marseille:achat', 100, "Masque42_1", "Masque42_1")
			elseif slide == 3 and btn == "Masque Monster 6" then
				TriggerServerEvent('marseille:achat', 100, "Masque42_2", "Masque42_2")
---------Man
elseif slide == 44 and btn == "Masque:" then  TriggerServerEvent('marseille:achat', 100, "Masque43", "Masque43")
	---------Girl
elseif slide == 45 and btn == "Masque:" then  TriggerServerEvent('marseille:achat', 100, "Masque44", "Masque44")
	---------Mask Oxygen 3
elseif slide == 46 and btn == "Masque:" then  TriggerServerEvent('marseille:achat', 100, "Masque45", "Masque45")
	---------Bandana
elseif slide == 48 and btn == "Masque:" then
	OpenMenu('Bandana')
elseif slide == 1 and btn == "Masque Bandana" then
	TriggerServerEvent('marseille:achat', 100, "Masque47", "Masque47")
elseif slide == 2 and btn == "Masque Bandana" then
	TriggerServerEvent('marseille:achat', 100, "Masque47_1", "Masque47_1")
elseif slide == 3 and btn == "Masque Bandana" then
	TriggerServerEvent('marseille:achat', 100, "Masque47_2", "Masque47_2")
		---------Bandana 2
elseif slide == 49 and btn == "Masque:" then
	OpenMenu('Bandana 2')
elseif slide == 1 and btn == "Masque Bandana 2" then
	TriggerServerEvent('marseille:achat', 100, "Masque48", "Masque48")
elseif slide == 2 and btn == "Masque Bandana 2" then
	TriggerServerEvent('marseille:achat', 100, "Masque48_1", "Masque48_1")
elseif slide == 3 and btn == "Masque Bandana 2" then
	TriggerServerEvent('marseille:achat', 100, "Masque48_2", "Masque48_2")

	---------Papier
elseif slide == 50 and btn == "Masque:" then
	OpenMenu('Papier')
elseif slide == 1 and btn == "Masque Papier" then
	TriggerServerEvent('marseille:achat', 100, "Masque49", "Masque49")
elseif slide == 2 and btn == "Masque Papier" then
	TriggerServerEvent('marseille:achat', 100, "Masque49_1", "Masque49_1")
elseif slide == 3 and btn == "Masque Papier" then
	TriggerServerEvent('marseille:achat', 100, "Masque49_2", "Masque49_2")

---------Hockey
elseif slide == 51 and btn == "Masque:" then
	OpenMenu('Hockey 5')
elseif slide == 1 and btn == "Masque Hockey 5" then
	TriggerServerEvent('marseille:achat', 100, "Masque50", "Masque50")
elseif slide == 2 and btn == "Masque Hockey 5" then
	TriggerServerEvent('marseille:achat', 100, "Masque50_1", "Masque50_1")
elseif slide == 3 and btn == "Masque Hockey 5" then
	TriggerServerEvent('marseille:achat', 100, "Masque50_2", "Masque50_2")

	---------Foulard
elseif slide == 52 and btn == "Masque:" then
	OpenMenu('Foulard')
elseif slide == 1 and btn == "Masque Foulard" then
	TriggerServerEvent('marseille:achat', 100, "Masque51", "Masque51")
elseif slide == 2 and btn == "Masque Foulard" then
	TriggerServerEvent('marseille:achat', 100, "Masque51_1", "Masque51_1")
elseif slide == 3 and btn == "Masque Foulard" then
	TriggerServerEvent('marseille:achat', 100, "Masque51_2", "Masque51_2")
elseif slide == 4 and btn == "Masque Foulard" then
	TriggerServerEvent('marseille:achat', 100, "Masque51_3", "Masque51_3")
elseif slide == 5 and btn == "Masque Foulard" then
	TriggerServerEvent('marseille:achat', 100, "Masque51_4", "Masque51_4")
elseif slide == 6 and btn == "Masque Foulard" then
	TriggerServerEvent('marseille:achat', 100, "Masque51_5", "Masque51_5")
elseif slide == 7 and btn == "Masque Foulard" then
	TriggerServerEvent('marseille:achat', 100, "Masque51_6", "Masque51_6")
elseif slide == 8 and btn == "Masque Foulard" then
	TriggerServerEvent('marseille:achat', 100, "Masque51_7", "Masque51_7")
elseif slide == 9 and btn == "Masque Foulard" then
	TriggerServerEvent('marseille:achat', 100, "Masque51_8", "Masque51_8")
elseif slide == 10 and btn == "Masque Foulard" then
	TriggerServerEvent('marseille:achat', 100, "Masque51_9", "Masque51_9")
	---------Foulard
elseif slide == 53 and btn == "Masque:" then
	OpenMenu('Cagoule 4')
elseif slide == 1 and btn == "Masque Cagoule 4" then
	TriggerServerEvent('marseille:achat', 100, "Masque52", "Masque52")
elseif slide == 2 and btn == "Masque Cagoule 4" then
	TriggerServerEvent('marseille:achat', 100, "Masque52_1", "Masque52_1")
elseif slide == 3 and btn == "Masque Cagoule 4" then
	TriggerServerEvent('marseille:achat', 100, "Masque52_2", "Masque52_2")
elseif slide == 4 and btn == "Masque Cagoule 4" then
	TriggerServerEvent('marseille:achat', 100, "Masque52_3", "Masque52_3")
elseif slide == 5 and btn == "Masque Cagoule 4" then
	TriggerServerEvent('marseille:achat', 100, "Masque52_4", "Masque52_4")
elseif slide == 6 and btn == "Masque Cagoule 4" then
	TriggerServerEvent('marseille:achat', 100, "Masque52_5", "Masque52_5")
elseif slide == 7 and btn == "Masque Cagoule 4" then
	TriggerServerEvent('marseille:achat', 100, "Masque52_6", "Masque52_6")
elseif slide == 8 and btn == "Masque Cagoule 4" then
	TriggerServerEvent('marseille:achat', 100, "Masque52_7", "Masque52_7")
elseif slide == 9 and btn == "Masque Cagoule 4" then
	TriggerServerEvent('marseille:achat', 100, "Masque52_8", "Masque52_8")
elseif slide == 10 and btn == "Masque Cagoule 4" then
	TriggerServerEvent('marseille:achat', 100, "Masque52_9", "Masque52_9")

		---------Cagoule 5
elseif slide == 54 and btn == "Masque:" then
	OpenMenu('Cagoule 5')
elseif slide == 1 and btn == "Masque Cagoule 5" then
	TriggerServerEvent('marseille:achat', 100, "Masque53", "Masque53")
elseif slide == 2 and btn == "Masque Cagoule 5" then
	TriggerServerEvent('marseille:achat', 100, "Masque53_1", "Masque53_1")
elseif slide == 3 and btn == "Masque Cagoule 5" then
	TriggerServerEvent('marseille:achat', 100, "Masque53_2", "Masque53_2")
		---------Bandana 3
elseif slide == 55 and btn == "Masque:" then
	OpenMenu('Bandana 3')
elseif slide == 1 and btn == "Masque Bandana 3" then
	TriggerServerEvent('marseille:achat', 100, "Masque54", "Masque54")
elseif slide == 2 and btn == "Masque Bandana 3" then
	TriggerServerEvent('marseille:achat', 100, "Masque54_1", "Masque54_1")
elseif slide == 3 and btn == "Masque Bandana 3" then
	TriggerServerEvent('marseille:achat', 100, "Masque54_2", "Masque54_2")
elseif slide == 4 and btn == "Masque Bandana 3" then
	TriggerServerEvent('marseille:achat', 100, "Masque54_3", "Masque54_3")
elseif slide == 5 and btn == "Masque Bandana 3" then
	TriggerServerEvent('marseille:achat', 100, "Masque54_4", "Masque54_4")
elseif slide == 6 and btn == "Masque Bandana 3" then
	TriggerServerEvent('marseille:achat', 100, "Masque54_5", "Masque54_5")
elseif slide == 7 and btn == "Masque Bandana 3" then
	TriggerServerEvent('marseille:achat', 100, "Masque54_6", "Masque54_6")
elseif slide == 8 and btn == "Masque Bandana 3" then
	TriggerServerEvent('marseille:achat', 100, "Masque54_7", "Masque54_7")
elseif slide == 9 and btn == "Masque Bandana 3" then
	TriggerServerEvent('marseille:achat', 100, "Masque54_8", "Masque54_8")
elseif slide == 10 and btn == "Masque Bandana 3" then
	TriggerServerEvent('marseille:achat', 100, "Masque54_9", "Masque54_9")

		---------Mask Oxygen 3
elseif slide == 56 and btn == "Masque:" then  TriggerServerEvent('marseille:achat', 100, "Masque55", "Masque55")
---------Cagoule 7
elseif slide == 57 and btn == "Masque:" then
	OpenMenu('Cagoule 7')
elseif slide == 1 and btn == "Masque Cagoule 7" then
	TriggerServerEvent('marseille:achat', 100, "Masque56", "Masque56")
elseif slide == 2 and btn == "Masque Cagoule 7" then
	TriggerServerEvent('marseille:achat', 100, "Masque56_1", "Masque56_1")
elseif slide == 3 and btn == "Masque Cagoule 7" then
	TriggerServerEvent('marseille:achat', 100, "Masque56_2", "Masque56_2")
	---------Cagoule 8
elseif slide == 58 and btn == "Masque:" then
	OpenMenu('Cagoule 8')
elseif slide == 1 and btn == "Masque Cagoule 8" then
	TriggerServerEvent('marseille:achat', 100, "Masque57", "Masque57")
elseif slide == 2 and btn == "Masque Cagoule 8" then
	TriggerServerEvent('marseille:achat', 100, "Masque57_1", "Masque57_1")
elseif slide == 3 and btn == "Masque Cagoule 8" then
	TriggerServerEvent('marseille:achat', 100, "Masque57_2", "Masque57_2")
	---------Cagoule 9
elseif slide == 59 and btn == "Masque:" then
	OpenMenu('Cagoule 9')
elseif slide == 1 and btn == "Masque Cagoule 9" then
	TriggerServerEvent('marseille:achat', 100, "Masque58", "Masque58")
elseif slide == 2 and btn == "Masque Cagoule 9" then
	TriggerServerEvent('marseille:achat', 100, "Masque58_1", "Masque58_1")
elseif slide == 3 and btn == "Masque Cagoule 9" then
	TriggerServerEvent('marseille:achat', 100, "Masque58_2", "Masque58_2")
	---------Monster 7
elseif slide == 60 and btn == "Masque:" then  TriggerServerEvent('marseille:achat', 100, "Masque59", "Masque59")
	--------Citrouille
elseif slide == 61 and btn == "Masque:" then
	OpenMenu('Citrouille')
elseif slide == 1 and btn == "Masque Citrouille" then
	TriggerServerEvent('marseille:achat', 100, "Masque60", "Masque60")
elseif slide == 2 and btn == "Masque Citrouille" then
	TriggerServerEvent('marseille:achat', 100, "Masque60_1", "Masque60_1")
elseif slide == 3 and btn == "Masque Citrouille" then
	TriggerServerEvent('marseille:achat', 100, "Masque60_2", "Masque60_2")
	...
	Menu = {
		["Masque disponibles: "] = {
			b = {
				{name = "Masque:", slidemax = yoyo},
				{name = "tout les masque sont à ~g~100$!", ask = "", askX = true},
